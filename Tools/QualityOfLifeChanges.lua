...
-- SW version, adjusted for T_SuperTechnology
-- 24.08.2018
...
function SW.QoL.Init()
	-- install hotkey and reinstall it on reload
	Input.KeyBindDown(Keys.Space, "SW.QoL.RemoveWorkingSerfsInSelection()", 2);
	SW.QoL.InitPlayerColorMapping = InitPlayerColorMapping
	InitPlayerColorMapping = function()
		SW.QoL.InitPlayerColorMapping()
		Input.KeyBindDown(Keys.Space, "SW.QoL.RemoveWorkingSerfsInSelection()", 2);
	end
